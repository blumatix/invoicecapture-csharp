...
namespace InvoiceCapture
{
    public class Options
    {
        ...
        [Option('s', "version", Required = false, DefaultValue = "v1-13", HelpText = "The version of the actual BLU DELTA release")]
        public string SdkVersion { get; set; }

        [Option('u', "baseUrl", Required = false, DefaultValue = "https://api.bludelta.ai/v1-13", HelpText = "Base url of your capturesdk version")]
