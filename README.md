...
```csharp
.\InvoiceCapture.exe -k YOUR_API_KEY -i PATH_TO_AN_INVOICE -u https://api.bludelta.ai
```
...
Copyright c  2017
  ...
  -s, --version          (Default: v1-11) The version of the actual BLU DELTA
                         release

  -u, --baseUrl          (Default: https://api.bludelta.ai) Base url of your
                         capturesdk version
